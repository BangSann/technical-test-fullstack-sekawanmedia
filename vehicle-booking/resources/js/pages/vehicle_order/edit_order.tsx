...
import { update } from '@/actions/App/Http/Controllers/VehicleOrderController';
...
const EditOrderPage = ({
    ...
    drivers: Driver[];
    users: User[];
    approval_lvl1: VehicleOrderApproval;
    approval_lvl2: VehicleOrderApproval;
}) => {
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <Formik
                    initialValues={{
                        ...
                        approval_id_lvl1: approval_lvl1?.approver_id,
                        approval_id_lvl2: approval_lvl2?.approver_id,
                    }}
                    validationSchema={validationSchema}
                    onSubmit={(values) => {
                        router.patch(update(order?.id), values, {
                            onStart: () => {},
                            onFinish: () => {
                                setIsLoading(false);
                            },
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <Select
                                        ...
                                        value={values?.approval_id_lvl1?.toString()}
                                    >
                                        <SelectTrigger>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <Select
                                        ...
                                        value={values?.approval_id_lvl2?.toString()}
                                    >
                                        <SelectTrigger>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <Select
                                        ...
                                        value={values?.vehicle_id?.toString()}
                                    >
                                        <SelectTrigger>
